      ...
      *> Declaração do arquivo
           ...
           select arqEstados assign to "arqEstadosRel.txt"   *> adiciona nome arquivo    *> assing vou estar assossiando o arquivo fisico
           organization is relative                       *> forma de como sao organizados os dados/aruivo
           access mode is dynamic                         *> assesaando o aquivo/dados
           lock mode is automatic                         *> serve para travar o arquivo
           relative is ws-rk-arqEstados                   *> chave relativa para acesso randomico (acesso direto)
           file status is ws-fs-arqEstados.               *> é utilizado uma variavel da wokking-storage para retorno correto do aqruivo
